	        ...
	        <div class="col-lg-12">
	          <div class="card">
	            <div class="card-body">
	            	...
	            	<div class="row">
	            		<form class="cmxform" id="editProfile" method="post" action="{{ route('transaction.search') }}">
			              	@csrf
			                <fieldset>

			                  <div class="form-group">
			                    <label for="trxno">Transaction number</label>
			                    <input id="trxno" class="form-control" name="trxno" value="{{ empty(request()->post('trxno')) ? '' : request()->post('trxno')}}" type="text">
			                  </div>
			                  @if(!empty($found_trx_message))
			                  <p class="text-danger">{{ $found_trx_message}}</p>
			                  @endif
